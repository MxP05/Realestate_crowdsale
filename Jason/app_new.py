...
# Create instances of each crowdsale contract
    ...
    property_info = {
        'Property 1': 'Location: Tokyo, Akasaka district in Minato Ward. 4 minutes from Akasaka train station. Property includes land and building. Commercial zone. Est building price: $555,100,000',
        'Property 2': 'Location: Tokyo, Yombancho district in Chiyoda Ward.4 minutes from Ichigaya train station. Propperty includes land and building. Commercial zone. Est building price: $345,800,000',
        'Property 3': 'Location: Tokyo, Niijuku district in Katsushika Ward. 9 minutes from Kanamachi train station. Property includes only land. Industrial zone. Est building price: $409,500,000',
    }
...
# Display the selected property's information
    ...
    token_details = {
        'Property 1': {'name': 'AkasakaCoin', 'symbol': 'AKC', 'price': 0.3},
        'Property 2': {'name': 'ChiyodaCoin', 'symbol': 'CYC', 'price': 0.3},
        'Property 3': {'name': 'NiijukuCoin', 'symbol': 'NJC', 'price': 0.3},
    }
...
# Define the load_contract function
    ...
    # Set the contract address (this is the address of the deployed contract)
         contract_address = "0x3E808F9984018a6Fd84d1B616f9eC79017B5dA53"
