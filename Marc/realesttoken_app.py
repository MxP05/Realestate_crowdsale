...
tab1, tab2, tab3, tab4, tab5 = st.tabs(['Project','ICO Platform','something','something','Property NFTs'])
...
# Define the load_contract function
    ...
    # Load Art Gallery ABI
         with open(Path('../Jason/Akasakacoin_abi.json')) as f:
...
################################################################################
    ...
    account = accounts
    wallet_balance = st.selectbox("Select Account", options=account) # Student's wallet.
    if st.button("Display Wallet Balance"):
            Balance_of=contract.functions.balanceOf(wallet_balance).call()
